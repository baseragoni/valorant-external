using ValExt.App.Commands;
using ValExt.ChainProviders.Evm;
using ValExt.ChainProviders.Transport;
using ValExt.ChainProviders.Utxo;
using ValExt.Cryptography.Derivation;
using ValExt.Cryptography.Vault;
using ValExt.Engine.Analytics;
using ValExt.Engine.Domain.Contracts;
using ValExt.Engine.Networks;
using ValExt.Engine.Options;
using ValExt.Engine.Orchestration;
using ValExt.Persistence.Stores;
using Microsoft.Extensions.Logging;
using Microsoft.Extensions.Options;

namespace ValExt.App.Bootstrap;
